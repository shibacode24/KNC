    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding:1px 5px 2px 5px;">
                ...
                <div class="col-md-12" style="margin-top:5px;">
                    <div class="panel panel-default">
                        <h5 class="panel-title"
                            ...
                            align="center">
                            <i class="fa fa-bars"></i> &nbsp;Add Site Manager
                        </h5>
                    </div>
                </div>
                @if(session('success'))
                ...
                @endif
                <form action="{{ route('site_managerstore') }}" method="post">
                    @csrf
                    ...
                    <div class="col-md-12" style="margin-top:15px;">
                        <div class="panel panel-default">
                            <h5 class="panel-title"
                                style="color:#FFFFFF; background-color:#006699; width:100%; font-size:14px;margin-top: 1vh;"
                                align="center">
                                <i class="fa fa-bars"></i> &nbsp;Added Site manager
                            </h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: #ffffff;">
                                            <div class="d-flex align-items-center">
                                                       ...
                                                       <?php if ($sites->status=='1'){?>
                                                        ...
                                                        <a href="{{url('/update_site_manager_status', $sites->id)}}"
                                        ...
                                        <a href="{{route('edit_site_manager',$sites->id)}}">    <button
                                                ...
                                                {{-- <a href="{{ route('delete_site_manager', $sites->id) }}" onclick="return confirm('Are you sure you want to delete this?')">
