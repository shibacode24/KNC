    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding:1px 5px 2px 5px;">
                ...
                <div class="col-md-12" style="margin-top:5px;">
                    <div class="panel panel-default">
                        <h5 class="panel-title"
                            ...
                            align="center">
                            <i class="fa fa-bars"></i> &nbsp;Update Site Incharge
                        </h5>
                    </div>
                </div>
                @if(session('success'))
                ...
                @endif
                <form action="{{ route('update_site_incharge') }}" method="post">
                    @csrf
                    <div class="col-md-12" style="margin-top:10px;">
                       <input type="hidden" name="id" value="{{$edit_site_incharge->id}}">
                        <div class="col-md-2">
                            <label class="control-label">Name<font color="#FF0000">*</font></label>

                            <input type="text" class="form-control" name="employee_name" value="{{$edit_site_incharge->employee_name}}" placeholder="" required />
                        </div>
                        
                        <div class="col-md-2">
                            <label class="control-label">Mobile Number<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="mobile_number" maxlength="10" value="{{$edit_site_incharge->mobile_number}}" placeholder="" required />
                        </div>

                        <div class="col-md-2">
                            <label class="control-label">Aadhar Number<font color="#FF0000">*</font></label>
                            <input type="number" class="form-control" name="aadhar_number" value="{{$edit_site_incharge->aadhar_number}}" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">PAN Number<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="pan_number" value="{{$edit_site_incharge->pan_number}}" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                            <label>City</label>
                            <select class="form-control select" data-live-search="true" name="city_id">
                                @foreach($city as $city)
                                <option value="{{ $city->id }}" @if ($edit_site_incharge->city_id == $city->id)
                                    selected
                        ...
                        <div class="col-md-2" style="margin-top: 5px;">
                            ...
                            <input type="text" class="form-control" name="city_address" value="{{$edit_site_incharge->city_address}}" placeholder="" required />
                        </div>
                        ...
                        <div class="col-md-2" style="margin-top: 5px;">
                            ...
                            <input type="text" class="form-control" name="account_holder" value="{{$edit_site_incharge->account_holder}}" placeholder="" />
                        </div>
                        <div class="col-md-2" style="margin-top: 5px;">
                            <label class="control-label">Bank Name<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="bank_name" value="{{$edit_site_incharge->bank_name}}" placeholder="" />
                        </div>

                        <div class="col-md-2" style="margin-top: 5px;">
                            <label class="control-label">Account Number<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="account_number" value="{{$edit_site_incharge->account_number}}" placeholder="" />
                        </div>
                        <div class="col-md-2" style="margin-top: 5px;">
                            <label class="control-label">IFSC Code<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="ifsc_code" value="{{$edit_site_incharge->ifsc_code}}" placeholder="" />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Email<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="email" value="{{$edit_site_incharge->email}}" placeholder="" required />
                        </div>
                        <div class="col-md-2" style="margin-top: 5px;">
