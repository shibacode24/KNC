        ...
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding:1px 5px 2px 5px;">
                ...
                <div class="col-md-12" style="margin-top:10px;">
                    <form action="{{ route('warehousestore') }}" method="post">
                        @csrf
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="warehouse_name" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Incharge Name<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="incharge_name" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-12" style="margin-top:15px;" align="">
                    ...
                    <div class="col-md-12" style="margin-top:15px;">
                        <div class="panel panel-default">
                            <h5 class="panel-title"
                                style="color:#FFFFFF; background-color:#006699; width:100%; font-size:14px;margin-top: 1vh;"
                                align="center">
                                <i class="fa fa-university"></i> &nbsp;Added Warehouse
                            </h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $Warehouse->incharge_name ?? null}}</td>
                                        <td>{{ $Warehouse->incharge_contact ?? null}}</td>
                                        <td>{{ $Warehouse->cityname->city ?? null}}</td>
                                        <td>{{ $Warehouse->latitude ?? null}}</td>
                                        <td>{{ $Warehouse->longitude ?? null}}</td>
                                        <td>
                                            ...
                                            <button
                                                ...
                                                data-placement="top" title="Edit"><i class="fa fa-edit"
                                                    ...
                                                    <a href="{{ route('warehouse-destroy', $Warehouse->id) }}"><button
                                                        style="background-color:#ff0000; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                                        type="button" class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="top" title="Delete"
                                                        onclick="confirmDelete({{ $Warehouse->id }})"><i
