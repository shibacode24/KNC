                        ...
                        <div class="panel-body" style="margin-top:5px; margin-bottom:15px;">
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $accountDetail->supervisor->supervisor_name }}</td>
                                        <td>{{ $accountDetail->supervisor->email }}</td>
                                        <td>{{ $accountDetail->supervisor->mobile_number }}</td>
                                        {{-- <td>{{ $accountDetail->supervisor->whatsapp_number }}</td> --}}
                                        <td>{{ $accountDetail->supervisor->aadhar_number }}</td>
                                        <td>{{ $accountDetail->supervisor->pan_number }}</td>
                                        <td>{{ $accountDetail->supervisor->cityname->city }}</td>
                                        <td>{{ $accountDetail->supervisor->city_address }}</td>
