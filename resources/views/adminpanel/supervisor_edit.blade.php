            ...
            @endif
                ...
                <form action="{{ route('supervisor.update') }}" method="post">
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        ...
                        <input type="hidden" name="id" value="{{$supervisor_edit->id}}">

                        <div class="col-md-2">
                            <label class="control-label">Name<font color="#FF0000">*</font></label>

                            <input type="text" class="form-control" name="supervisor_name" value="{{$supervisor_edit->supervisor_name}}" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Email / User Name<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="email" placeholder="" value="{{$supervisor_edit->email}}" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Mobile Number<font color="#FF0000">*</font></label>
                            <input type="number" class="form-control" name="mobile_number" value="{{$supervisor_edit->mobile_number}}" placeholder="" required />
                        </div>

                        <div class="col-md-2">
                            <label class="control-label">Aadhar Number<font color="#FF0000">*</font></label>
                            <input type="number" class="form-control" name="aadhar_number" value="{{$supervisor_edit->aadhar_number}}" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">PAN Number<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="pan_number" value="{{$supervisor_edit->pan_number}}" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                            <label>City</label>
                        ...
                        <div class="col-md-2" style="margin-top: 5px;">
                            ...
                            <input type="text" class="form-control" name="city_address" value="{{$supervisor_edit->city_address}}" placeholder="" required />
                        </div>
{{--
                        <div class="col-md-2" style="margin-top: 5px;">
