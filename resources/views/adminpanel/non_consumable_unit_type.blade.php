        ...
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding:1px 5px 2px 5px;">
                ...
                <div class="col-md-12" style="margin-top:10px;">
                    <form action="{{ route('non_consumable_unit_type_store') }}" method="post">
                        @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('non_consumable_unit_type_edit', $unit_type->id) }}"><button
                                                ...
                                                data-placement="top" title="Edit"><i class="fa fa-edit"
                                                    ...
                                                    <a href="{{ route('non_consumable_unit_type_delete', $unit_type->id) }}" ><button
