            ...
            <div class="col-md-12">
                ...
                <div class="panel-body" style="padding:1px 5px 2px 5px;">
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        <form action="{{ route('non_consumable_brand_store') }}" method="post">
                            @csrf
                                        ...
                                        @foreach ($brand as $brand)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('non_consumable_brand_edit', $brand->id) }}"><button
                                                    ...
                                                    <a href="{{ route('non_consumable_brand_destroy', $brand->id) }}"><button
