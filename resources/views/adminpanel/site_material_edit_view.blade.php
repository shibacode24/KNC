    <form action="{{route('update_site_material')}}" method="post" style="background: white">
        @csrf
    ...
    {{-- @json($appendData) --}}
                        ...
                        <tr>
                            ...
                            <td style="padding:5px;" align="center">
                                <input type="hidden" name="data[{{ $loop->index }}][unit_type]" value="{{ $data->material_unit_id }}">
                            ...
                            <td style="padding:5px;" align="center">
                                <input type="text" class="form-control remaining-material" name="data[{{ $loop->index }}][remaining_material]" placeholder="" style="color: #707B7C;" value="0" readonly />
