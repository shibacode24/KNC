                ...
                <div class="col-md-12" style="margin-top:5px;">
                    <div class="panel panel-default">
                        <h5 class="panel-title"
                            ...
                            align="center">
                            <i class="fa fa-plus"></i> &nbsp;Add Non Consumable Categories Material
                        </h5>
                ...
                <div class="col-md-12" style="margin-top:10px;">
                    <form action="{{ route('non-consumable-category-material-store') }}" method="post">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-control select" name="category" data-live-search="true">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $material->category_name->category ?? null}}</td>
                                        <td>{{ $material->material ?? null}}</td>
                                        <td>

                                            {{-- <a href="{{ route('unit-type-edit', $material->id) }}"><button
                                                ...
                                                data-placement="top" title="Edit"><i class="fa fa-edit"
                                                    ...
                                                    <a href="{{ route('non-consumable-category-material-destroy', $material->id) }}"><button
