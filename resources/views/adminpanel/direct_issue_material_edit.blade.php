            ...
            <div class="panel-body" style="padding:1px 5px 2px 5px;">
                ...
                <div class="col-md-12" style="margin-top:5px;">
                    <div class="panel panel-default">
                        <h5 class="panel-title"
                            ...
                            align="center">
                            <i class="fa fa-plus"></i> &nbsp;Edit Direct Issue Materials
                        </h5>
                    </div>
                </div>

                <form action="{{route('update-direct-issue-material')}}" method="post">
                    @csrf
                ...
                <div class="col-md-12" style="margin-top:10px;">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-control select" data-live-search="true" name="warehouse" id="warehouse">
                          <option value="">--Select--</option>
                            ...
                            <option value="{{ $warehouse->id }}" {{ old('warehouse', $issueEdit->selected_warehouse_id) == $warehouse->id ? 'selected' : '' }}>{{$warehouse->warehouse_name}}</option>
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-control select" data-live-search="true" name="site" id="site">
                          <option value="">--Select--</option>
                            ...
                            <option value="{{ $site->id }}" {{ old('site', $issueEdit->site_id) == $site->id ? 'selected' : '' }}>{{$site->site_name}}</option>
                    ...
                    <div class="col-md-2"  style="margin-top: 20px">
                        ...
                        <input type="number" class="form-control" name="quantity" placeholder="" value="{{$issueEdit->requested_material_quantity}}"/>
                    </div>

                    <div class="col-md-2"  style="margin-top: 20px">
                        <label class="control-label">Remark<font color="#FF0000">*</font></label>
                    <textarea name="remark"  class="form-control" id="remark" cols="30" rows="3">{{$issueEdit->remark}}</textarea>
                    </div>
