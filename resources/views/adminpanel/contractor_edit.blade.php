            ...
            <div class="panel-body" style="padding:1px 5px 2px 5px;">
                ...
                <div class="col-md-12" style="margin-top:5px;">
                    <div class="panel panel-default">
                        <h5 class="panel-title"
                            ...
                            align="center">
                            <i class="fa fa-bars"></i> &nbsp;Add Contractors
                        </h5>
                ...
                <form action="{{ route('contractor.update') }}" method="post">
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        ...
                        <input type="hidden" name="id" value="{{$contractor_edit->id}}">

                        <div class="col-md-2">
                            <label class="control-label">Name<font color="#FF0000">*</font></label>

                            <input type="text" class="form-control" name="contractor_name" placeholder="" value="{{$contractor_edit->contractor_name}}" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Email<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="email" placeholder="" value="{{$contractor_edit->email}}" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Mobile Number<font color="#FF0000">*</font></label>
                            <input type="number" class="form-control" name="mobile_number" placeholder="" value="{{$contractor_edit->mobile_number}}" required />
                        </div>

                        <div class="col-md-2">
                            <label class="control-label">Aadhar Number<font color="#FF0000">*</font></label>
                            <input type="number" class="form-control" name="aadhar_number" placeholder="" value="{{$contractor_edit->aadhar_number}}" required />
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">PAN Number<font color="#FF0000">*</font></label>
                            <input type="text" class="form-control" name="pan_number" placeholder="" value="{{$contractor_edit->pan_number}}" required />
                        </div>
                        <div class="col-md-2">
                            <label>City</label>
                        ...
                        <div class="col-md-2" style="margin-top: 5px;">
                            ...
                            <input type="text" class="form-control" name="city_address" placeholder="" value="{{$contractor_edit->city_address}}" required />
                        </div>
                    ...
                    <div class="col-md-12" style="margin-top:15px;">
                        <div class="panel panel-default">
                            <h5 class="panel-title"
                                style="color:#FFFFFF; background-color:#006699; width:100%; font-size:14px;margin-top: 1vh;"
                                align="center">
                                <i class="fa fa-bars"></i> &nbsp;Added contractor
                            </h5>
