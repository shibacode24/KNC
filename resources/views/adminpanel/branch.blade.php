                ...
                <div class="panel-body" style="padding:1px 5px 2px 5px;">
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        <form action="{{ route('branch.store') }}" method="post">
                            ...
                            <div class="col-md-2">
                                <label class="control-label">Add Branch<font color="#FF0000">*</font></label>
                                    ...
                                    <tbody>
                                        @foreach ($branch as $branch)
                                            <tr>
                                                ...
                                                <td>{{ $branch->branch ?? null }}</td>
                                                <td>

                                                    <a href="{{ route('branch-edit', $branch->id) }}"><button
                                                        style="background-color:#3399ff; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                                        type="button" class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="top" title="Edit"><i class="fa fa-edit"
                                                            style="margin-left:5px;"></i></button></a>

                                                    <a href="{{ route('branch-destroy', $branch->id) }}"><button
