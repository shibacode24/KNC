                ...
                <form action="{{ route('contractor.store') }}" method="post">
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="contractor_name" placeholder="" required />
                        </div>
                        <div class="col-md-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href="{{ route('contractor-edit', $accountDetail->id) }}"><button
                                                style="background-color:#3399ff; border:none; max-height:25px; margin-top:-5px; margin-bottom:-5px;"
                                                type="button" class="btn btn-info" data-toggle="tooltip"
                                                data-placement="top" title="Edit"><i class="fa fa-edit"
                                                    style="margin-left:5px;"></i></button>
                                            </a> --}}
                                                    {{-- <a href="{{ route('contractor-destroy', $accountDetail->id) }}"><button
