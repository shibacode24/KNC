<form action="{{ route('nonConsumable_addIssuedMaterial') }}" method="post" style="background: white">
    @csrf
        ...
        <tr>
            <table width="100%" border="1" style="margin-top: 5px;">
                <tr style="background-color:#f0f0f0; height:30px;">
                    ...
                    <th width="10%" style="text-align:center">Available Material<strong>
                            <font color="#FF0000">*</font>
                        </strong></th>
                    <th width="10%" style="text-align:center">Issue Material<strong>
                            <font color="#FF0000">*</font>
                        </strong></th>
                    <th width="10%" style="text-align:center">Remaining Material<strong>
                            <font color="#FF0000">*</font>
                        </strong></th>
                    <th width="2%" style="text-align:center">Remark</th>
                    <th width="11%" style="text-align:center">Status<strong>
                            <font color="#FF0000">*</font>
                        </strong></th>
                    ...
                    <tr>
                        ...
                        <td style="padding:10px;" align="center">
                            <select class="form-control select" data-live-search="true"
                                name="data[{{ $loop->index }}][warehouse]" data-loop-index="{{ $loop->index }}"
                                required>
                        ...
                        <td style="padding:5px;" align="center">
                            <input type="text" class="form-control available-material"
                                name="data[{{ $loop->index }}][available_material]" placeholder=""
                                style="color: #707B7C;" value="" readonly />
                        </td>
                        <td style="padding:10px;" align="center">
                            <input type="text" class="form-control issue-material" id="decrease_qnty"
                                name="data[{{ $loop->index }}][issue_material]" data-loop-index="{{ $loop->index }}"
                                placeholder="" />
                        </td>
                        <td style="padding:5px;" align="center">
                            <input type="text" class="form-control remaining-material"
                                name="data[{{ $loop->index }}][remaining_material]" placeholder=""
                                style="color: #707B7C;" readonly />
                        ...
                        <td style="padding:10px;" align="center">
                            <select class="form-control" data-live-search="true"
                                name="data[{{ $loop->index }}][status]" data-loop-index="{{ $loop->index }}">
...
<script>
    $(document).ready(function() {
        ...
        function updateRemainingMaterial(loopIndex) {
            var availableMaterial = parseFloat($('input[name="data[' + loopIndex + '][available_material]"]')
                .val()) || 0;
            var issueMaterial = parseFloat($('input[name="data[' + loopIndex + '][issue_material]"]').val()) ||
                0;
